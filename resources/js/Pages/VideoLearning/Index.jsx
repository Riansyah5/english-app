                    ...
                    <div className="flex flex-col sm:flex-row sm:items-center justify-between gap-3.5">
                        <div>
                            <div className="flex items-center gap-2 flex-wrap">
                                ...
                                <span className="shrink-0 px-2 sm:px-2.5 py-0.5 rounded-full text-[10px] sm:text-xs font-bold bg-[#60f2ce]/20 text-[#0d9488] border border-[#60f2ce]/50">
                        ...
                        <div className="flex items-center gap-2 shrink-0">
                            <div className="inline-flex items-center gap-1.5 sm:gap-2 px-3 sm:px-4 py-1.5 sm:py-2 bg-white border border-slate-200 rounded-full shadow-xs text-[11px] sm:text-xs font-semibold text-slate-600 whitespace-nowrap">
                                ...
                                Total: <span className="font-bold text-slate-900">{totalVideos} Video</span>
                            </div>
                            <Link 
                                href="/home" 
                                className="px-3 sm:px-4 py-1.5 sm:py-2 text-[11px] sm:text-xs font-semibold text-slate-600 bg-white border border-slate-200 rounded-full shadow-xs hover:bg-slate-50 transition whitespace-nowrap active:scale-95"
                            >
                                Ke Dashboard
                            </Link>
                        </div>
                    ...
                    {folders.length > 0 ? (
                        folders.map((folder) => (
                            <div key={folder.id} className="space-y-4">
                                ...
                                {/* Folder Header Card */}
                                <div className="flex items-center justify-between gap-3 bg-white p-3.5 sm:p-4 md:p-5 rounded-2xl sm:rounded-3xl border border-slate-100 shadow-[0_4px_24px_-4px_rgba(0,0,0,0.03)]">
                                    <div className="flex items-center gap-2.5 sm:gap-3.5 min-w-0">
                                        <div className="w-10 h-10 sm:w-12 sm:h-12 rounded-xl sm:rounded-2xl bg-gradient-to-br from-[#fcbf49] to-[#ff822d] text-white flex items-center justify-center text-lg sm:text-xl shadow-xs shadow-[#ff822d]/20 shrink-0">
                                    ...
                                    <span className="shrink-0 px-2.5 sm:px-3 py-1 rounded-full text-[10px] sm:text-xs font-bold bg-[#60f2ce]/20 text-[#0d9488] border border-[#60f2ce]/50 whitespace-nowrap">
                                    ...
                                    {folder.videos && folder.videos.length > 0 ? (
                                        folder.videos.map((video) => (
                                            ...
                                            >
                                                ...
                                                <div className="relative overflow-hidden bg-slate-900 h-44 sm:h-48">
                                                    <img 
                                                    ...
                                                    <div className="absolute inset-0 flex items-center justify-center opacity-0 group-hover:opacity-100 transition-opacity duration-300 pointer-events-none">
                                                        <div className="w-12 h-12 p-3 bg-gradient-to-tr from-[#60f2ce] to-[#fefc7c] rounded-full flex items-center justify-center shadow-lg transform scale-90 group-hover:scale-100 transition-transform duration-300">
                                                            <svg className="w-5 h-5 text-slate-900 translate-x-0.5" fill="currentColor" viewBox="0 0 24 24">
                                                    ...
                                                    {video.difficulty && (
                                                        <div className="absolute bottom-3 right-3 z-10">
                                                            <span className="text-[10px] sm:text-[11px] font-bold uppercase px-2 sm:px-2.5 py-0.5 sm:py-1 bg-[#fefc7c]/90 backdrop-blur-md text-slate-800 rounded-lg border border-[#fefc7c] shadow-xs">
                                                                {video.difficulty}
                                                            </span>
                                                        </div>
                                                    )}
