        ...
        <AuthenticatedLayout user={auth.user}>
            ...
            <div className="container mx-auto px-4 py-8 max-w-4xl relative z-10">
                <div className="flex items-center mb-8">
                    ...
                    <div>
                        <h3 className="text-2xl font-bold text-slate-900 dark:text-white mb-1">Tambah Video Baru 🎬</h3>
                        <p className="text-slate-500 dark:text-slate-400 text-sm m-0">Unggah video YouTube beserta transkrip dan terjemahannya.</p>
                    </div>
                </div>
                    ...
                    <form onSubmit={submit} className="flex flex-col gap-6">
                        ...
                        <div>
                            ...
                            <div className="bg-slate-50 dark:bg-slate-900/50 border border-slate-200 dark:border-slate-700 rounded-xl p-4 mb-4">
                                ...
                                <p className="text-xs text-slate-500 m-0">Contoh:</p>
                                <pre className="text-xs text-slate-600 dark:text-slate-400 m-0">
                            ...
                            <textarea 
                                ...
                                className={`w-full px-4 py-3 rounded-xl border bg-white dark:bg-slate-900 focus:ring-2 focus:ring-blue-500 outline-none transition-colors ${errors.transcripts ? 'border-rose-500' : 'border-slate-200 dark:border-slate-700'} text-slate-900 dark:text-white font-mono text-sm`}
                                required
                            ></textarea>
                        ...
                        <div className="flex justify-end items-center gap-3 mt-4">
                            ...
                            >
                                <i className="bi bi-save mr-2"></i> {processing ? 'Menyimpan...' : 'Simpan Video'}
                            </button>
                        </div>
                    </form>
                </div>
