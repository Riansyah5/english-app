        ...
        <AuthenticatedLayout user={auth.user}>
            ...
            <div className="min-h-screen bg-[#fafcfb] dark:bg-[#0b1120] text-slate-800 dark:text-slate-100 p-6 md:p-8 font-sans transition-colors duration-200">
                <div className="max-w-7xl mx-auto space-y-7">
                    ...
                    <div className="bg-white dark:bg-slate-900/90 rounded-3xl border border-slate-100 dark:border-slate-800/80 p-6 sm:p-8 shadow-[0_4px_24px_-4px_rgba(0,0,0,0.04)] dark:shadow-none relative overflow-hidden transition-colors">
                        <div className="absolute top-0 right-0 w-44 h-44 bg-[#fefc7c]/40 dark:bg-[#fefc7c]/10 rounded-full blur-2xl pointer-events-none" />
                        ...
                        <div className="flex flex-col md:flex-row justify-between items-start md:items-center relative z-10 gap-5">
                            <div>
                                <Link 
                                    ...
                                    className="inline-flex items-center gap-1.5 text-xs font-semibold text-slate-500 dark:text-slate-400 hover:text-[#ff822d] dark:hover:text-[#ff822d] transition-colors mb-3"
                                >
                    ...
                    <div className="grid grid-cols-1 lg:grid-cols-12 gap-7 items-start">
                        ...
                        <div className="lg:col-span-5">
                            <div className="bg-white dark:bg-slate-900/90 rounded-3xl border border-slate-100 dark:border-slate-800/80 p-6 shadow-[0_4px_24px_-4px_rgba(0,0,0,0.04)] dark:shadow-none sticky top-6 transition-colors">
                                <div className="flex items-center gap-2.5 pb-4 mb-5 border-b border-slate-100 dark:border-slate-800">
                                    ...
                                    <div>
                                        <h2 className="text-base font-extrabold text-slate-900 dark:text-white leading-tight">Tambah Baris Dialog</h2>
                                        <p className="text-[11px] text-slate-400 dark:text-slate-500">Tambahkan kalimat percakapan berikutnya</p>
                                    </div>
                                </div>
                                ...
                                <form onSubmit={submit} className="space-y-4">
                                    <div className="grid grid-cols-2 gap-3.5">
                                        <div>
                                            ...
                                            <input 
                                                ...
                                                className={`w-full px-3.5 py-2.5 text-xs font-semibold rounded-2xl border bg-[#fafcfb] dark:bg-slate-800/80 focus:bg-white dark:focus:bg-slate-800 focus:ring-2 focus:ring-[#60f2ce] focus:border-[#60f2ce] outline-none transition-all ${
                                                    errors.character_name ? 'border-rose-400 dark:border-rose-500 bg-rose-50/30 dark:bg-rose-500/10' : 'border-slate-200 dark:border-slate-700/80'
                                                } text-slate-900 dark:text-white placeholder:text-slate-400 dark:placeholder:text-slate-500 shadow-2xs`}
                                                required
                                            />
                                            {errors.character_name && <p className="text-rose-500 dark:text-rose-400 text-xs font-semibold mt-1">{errors.character_name}</p>}
                                        </div>
                                        ...
                                        <div>
                                            ...
                                            <select 
                                                ...
                                                className="w-full px-3.5 py-2.5 text-xs font-bold rounded-2xl border border-slate-200 dark:border-slate-700/80 bg-[#fafcfb] dark:bg-slate-800/80 focus:bg-white dark:focus:bg-slate-800 focus:ring-2 focus:ring-[#60f2ce] focus:border-[#60f2ce] outline-none transition-all text-slate-800 dark:text-slate-100 shadow-2xs"
                                                required
                                            >
                                                <option value="male" className="dark:bg-slate-800">Laki-laki (Male)</option>
                                                <option value="female" className="dark:bg-slate-800">Perempuan (Female)</option>
                                            </select>
                                        </div>
                                    </div>
                                    ...
                                    <div>
                                        ...
                                        <textarea 
                                            ...
                                            className={`w-full p-3.5 text-xs font-medium rounded-2xl border bg-[#fafcfb] dark:bg-slate-800/80 focus:bg-white dark:focus:bg-slate-800 focus:ring-2 focus:ring-[#60f2ce] focus:border-[#60f2ce] outline-none transition-all leading-relaxed ${
                                                errors.text_en ? 'border-rose-400 dark:border-rose-500 bg-rose-50/30 dark:bg-rose-500/10' : 'border-slate-200 dark:border-slate-700/80'
                                            } text-slate-900 dark:text-white placeholder:text-slate-400 dark:placeholder:text-slate-500 shadow-2xs`}
                                            required
                                        />
                                        {errors.text_en && <p className="text-rose-500 dark:text-rose-400 text-xs font-semibold mt-1">{errors.text_en}</p>}
                                    </div>
                                    ...
                                    <div>
                                        ...
                                        <textarea 
                                            ...
                                            className={`w-full p-3.5 text-xs font-medium rounded-2xl border bg-[#fafcfb] dark:bg-slate-800/80 focus:bg-white dark:focus:bg-slate-800 focus:ring-2 focus:ring-[#60f2ce] focus:border-[#60f2ce] outline-none transition-all leading-relaxed ${
                                                errors.text_id ? 'border-rose-400 dark:border-rose-500 bg-rose-50/30 dark:bg-rose-500/10' : 'border-slate-200 dark:border-slate-700/80'
                                            } text-slate-900 dark:text-white placeholder:text-slate-400 dark:placeholder:text-slate-500 shadow-2xs`}
                                            required
                                        />
                                        {errors.text_id && <p className="text-rose-500 dark:text-rose-400 text-xs font-semibold mt-1">{errors.text_id}</p>}
                                    </div>
                        ...
                        <div className="lg:col-span-7 space-y-4">
                            <div className="flex items-center justify-between pb-1">
                                <div className="flex items-center gap-2">
                                    <h2 className="text-base font-extrabold text-slate-900 dark:text-white">Alur Percakapan</h2>
                                    <span className="px-2.5 py-0.5 bg-[#60f2ce]/20 dark:bg-[#60f2ce]/15 text-[#0d9488] dark:text-[#60f2ce] rounded-full text-xs font-bold border border-[#60f2ce]/50 dark:border-[#60f2ce]/30">
                            ...
                            {shadowing.lines && shadowing.lines.length > 0 ? (
                                <div className="space-y-3">
                                    {shadowing.lines.map((line) => {
                                        ...
                                        return (
                                            <div 
                                                key={line.id} 
                                                className="bg-white dark:bg-slate-900/90 rounded-3xl border border-slate-100 dark:border-slate-800/80 p-5 shadow-[0_4px_24px_-4px_rgba(0,0,0,0.04)] dark:shadow-none hover:shadow-[0_8px_28px_-4px_rgba(0,0,0,0.06)] transition-all flex items-start gap-4 group relative"
                                            >
                                                ...
                                                <div className="shrink-0 flex flex-col items-center gap-1.5 w-16 text-center">
                                                    <div className={`w-11 h-11 rounded-2xl flex items-center justify-center text-lg font-black shadow-xs ${
                                                        isMale 
                                                            ? 'bg-[#60f2ce]/25 dark:bg-[#60f2ce]/20 text-[#0d9488] dark:text-[#60f2ce] border border-[#60f2ce]/50 dark:border-[#60f2ce]/30' 
                                                            : 'bg-[#ff822d]/15 dark:bg-[#ff822d]/20 text-[#c2410c] dark:text-[#ff822d] border border-[#ff822d]/35 dark:border-[#ff822d]/30'
                                                    }`}>
                                                        <i className="bi bi-person-fill"></i>
                                                    </div>
                                                    <span className="text-[10px] font-extrabold text-slate-700 dark:text-slate-200 uppercase truncate w-full tracking-wider">
                                                        {line.character_name}
                                                    </span>
                                                    <span className={`text-[9px] font-bold px-1.5 py-0.5 rounded-md font-mono uppercase ${
                                                        isMale ? 'bg-slate-100 dark:bg-slate-800 text-slate-500 dark:text-slate-400' : 'bg-orange-50 dark:bg-[#ff822d]/15 text-[#c2410c] dark:text-[#ff822d]'
                                                    }`}>
                                                        {line.voice_gender}
                                                    </span>
                                                </div>
                                                ...
                                                <div className="flex-grow pr-12">
                                                    <p className="font-bold text-sm sm:text-base text-slate-900 dark:text-white leading-snug mb-1">
                                                        {line.text_en}
                                                    </p>
                                                ...
                                                <div className="absolute top-4 right-4 flex items-center gap-1.5">
                                                    <button 
                                                        ...
                                                        className={`w-8 h-8 rounded-xl flex items-center justify-center transition-all shadow-2xs ${
                                                            isPlaying 
                                                                ...
                                                                : 'bg-slate-50 dark:bg-slate-800 border border-slate-200/80 dark:border-slate-700 text-slate-600 dark:text-slate-300 hover:bg-[#60f2ce]/20 hover:text-[#0d9488] dark:hover:text-[#60f2ce] hover:border-[#60f2ce]'
                                                        }`}
                                                    ...
                                                    <button 
                                                        ...
                                                        className="w-8 h-8 rounded-xl flex items-center justify-center bg-slate-50 dark:bg-slate-800 border border-slate-200/80 dark:border-slate-700 text-rose-500 hover:bg-rose-50 dark:hover:bg-rose-500/20 hover:border-rose-300 dark:hover:border-rose-500/30 transition-all shadow-2xs opacity-80 hover:opacity-100"
                                                ...
                                                <div className="absolute -top-2 -left-2 w-6 h-6 rounded-full bg-slate-900 dark:bg-slate-800 text-white flex items-center justify-center text-[10px] font-black shadow-xs border-2 border-white dark:border-slate-900">
                                                    {line.order_number || '#'}
                                                </div>
                                            </div>
                                        );
                                ...
                                <div className="p-12 text-center text-slate-400 dark:text-slate-500 border border-dashed border-slate-200 dark:border-slate-800 rounded-3xl bg-white dark:bg-slate-900/60 flex flex-col items-center justify-center min-h-[320px]">
                                    ...
                                    <h3 className="font-bold text-slate-900 dark:text-white text-base mb-1">Belum Ada Percakapan</h3>
