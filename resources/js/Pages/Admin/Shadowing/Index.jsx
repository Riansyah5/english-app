                                ...
                                <tbody className="divide-y divide-slate-100 dark:divide-slate-800">
                                    {topics.data && topics.data.length > 0 ? (
                                        topics.data.map((topic) => (
                                            <tr key={topic.id} className="hover:bg-[#fafcfb] dark:hover:bg-slate-850 transition-colors">
                                        ...
                                        <tr>
                                            <td colSpan="4" className="px-6 py-14 text-center">
                                                ...
                                                <h3 className="font-bold text-slate-900 dark:text-white text-base mb-1">Belum Ada Topik Shadowing</h3>
                                                <p className="text-xs text-slate-400 dark:text-slate-500">Silakan tambahkan topik baru untuk mulai menyusun dialog speaking.</p>
                                            </td>
                                        </tr>
                                    )}
                                </tbody>
