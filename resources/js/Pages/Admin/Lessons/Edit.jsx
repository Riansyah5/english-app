        ...
        <AuthenticatedLayout user={auth.user}>
            ...
            <div className="container mx-auto px-4 py-8 max-w-4xl relative z-10">
                <div className="flex items-center mb-8">
                    ...
                    <div>
                        <h3 className="text-2xl font-bold text-slate-900 dark:text-white mb-1">Edit Materi ✏️</h3>
                        <p className="text-slate-500 dark:text-slate-400 text-sm m-0">Perbarui konten HTML/Markdown untuk buku digital.</p>
                    </div>
                </div>
