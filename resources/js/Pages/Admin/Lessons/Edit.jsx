...
export default function LessonEdit({ auth, lesson, categories = [] }) {
    const { data, setData, put, processing, errors } = useForm({
        title: lesson.title || '',
        lesson_category_id: lesson.lesson_category_id || '',
        youtube_url: lesson.youtube_video_id ? `https://youtube.com/watch?v=${lesson.youtube_video_id}` : '',
    ...
    return (
        <AuthenticatedLayout user={auth.user}>
            <Head title={`Edit Materi - ${lesson.title}`} />
                        ...
                        <div className="flex items-center gap-3.5">
                            ...
                            <div>
                                ...
                                <p className="text-xs text-slate-400 font-medium mt-0.5">
                                    Perbarui naskah penjelasan, urutan bab, tautan video, atau status tayang.
                                </p>
                            </div>
                        </div>
                            ...
                            <div className="grid grid-cols-1 md:grid-cols-12 gap-5">
                                <div className="md:col-span-7">
                                    ...
                                    <input 
                                        ...
                                        placeholder="Judul Bab Pembelajaran"
                            ...
                            <div>
                                ...
                                <div className="mt-2.5 p-3.5 bg-[#fafcfb] rounded-2xl border border-slate-100 flex gap-2.5 items-start text-xs text-slate-600">
                                    ...
                                    <span className="leading-relaxed">
                                        Gunakan tag HTML semantik seperti <code className="bg-white px-1.5 py-0.5 rounded border border-slate-200 text-[#0d9488] font-bold font-mono text-[11px]">&lt;h2&gt;</code>, <code className="bg-white px-1.5 py-0.5 rounded border border-slate-200 text-[#0d9488] font-bold font-mono text-[11px]">&lt;p&gt;</code>, <code className="bg-white px-1.5 py-0.5 rounded border border-slate-200 text-[#0d9488] font-bold font-mono text-[11px]">&lt;ul&gt;</code>, dan <code className="bg-white px-1.5 py-0.5 rounded border border-slate-200 text-[#0d9488] font-bold font-mono text-[11px]">&lt;strong&gt;</code>. Konten ini langsung terhubung dengan styling <em>Tailwind Typography (prose)</em> pada tampilan pembaca buku digital.
                                    </span>
                                </div>
                            ...
                            <div className="p-4 rounded-2xl bg-[#fafcfb] border border-slate-100 flex items-center justify-between">
                                <div>
                                    ...
                                    <span className="text-[11px] text-slate-400">
                                        {data.is_published 
                                            ? 'Materi sedang aktif tayang dan dapat dibaca oleh seluruh siswa.' 
                                            : 'Disimpan sebagai draf (tidak tampil pada katalog siswa).'}
                                    </span>
                                </div>
