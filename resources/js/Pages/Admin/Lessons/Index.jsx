                                ...
                                <tbody className="divide-y divide-slate-100 dark:divide-slate-800">
                                    {lessons.data && lessons.data.length > 0 ? (
                                        lessons.data.map((lesson) => (
                                            <tr key={lesson.id} className="hover:bg-[#fafcfb] dark:hover:bg-slate-850 transition-colors">
                                                <td className="px-6 py-4">
                                                    <div className="flex items-center gap-3.5">
                                                        ...
                                                        <div className="truncate max-w-xs md:max-w-md">
                                                            ...
                                                            <span className="text-[11px] font-semibold text-slate-400 dark:text-slate-500 block mt-0.5 font-mono truncate">
                                                                /{lesson.slug}
                                                            </span>
                                                        </div>
                                                    </div>
                                                ...
                                                <td className="px-6 py-4 text-center">
                                                    {lesson.is_published ? (
                                                        <span className="px-2.5 py-1 text-[10px] font-mono font-bold uppercase rounded-lg bg-[#60f2ce]/20 dark:bg-[#60f2ce]/15 text-[#0d9488] dark:text-[#60f2ce] border border-[#60f2ce]/50 dark:border-[#60f2ce]/30">
                                                            Terbit
                                                        </span>
                                                    ) : (
                                                        <span className="px-2.5 py-1 text-[10px] font-mono font-bold uppercase rounded-lg bg-[#fefc7c]/80 dark:bg-amber-400/20 text-[#854d0e] dark:text-amber-300 border border-[#fcbf49]/50 dark:border-amber-400/30">
                                                            Draf
                                                        </span>
                                                    )}
                                                </td>
                                        ...
                                        <tr>
                                            <td colSpan="4" className="px-6 py-14 text-center">
                                                ...
                                                <h3 className="font-bold text-slate-900 dark:text-white text-base mb-1">Belum Ada Konten Materi</h3>
                                                <p className="text-xs text-slate-400 dark:text-slate-500">Silakan tambahkan bab atau materi bacaan baru untuk kategori buku yang ada.</p>
                                            </td>
                                        </tr>
                                    )}
                                </tbody>
