        ...
        <AuthenticatedLayout user={auth.user}>
            ...
            <div className="container mx-auto px-4 py-8 max-w-3xl relative z-10">
                <div className="flex items-center mb-8">
                    ...
                    <div>
                        <h3 className="text-2xl font-bold text-slate-900 dark:text-white mb-1">Tambah Kategori Baru 📖</h3>
                        <p className="text-slate-500 dark:text-slate-400 text-sm m-0">Buat folder baru untuk mengelompokkan buku materi digital.</p>
                    </div>
                </div>
                ...
                <div className="glass dark:glass-dark rounded-3xl p-6 sm:p-10 border border-slate-200 dark:border-slate-800 shadow-sm">
                    <form onSubmit={submit} className="flex flex-col gap-6">
                        ...
                        <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
                            <div className="md:col-span-2">
                                ...
                                <input 
                                    ...
                                    placeholder="Contoh: Basic Grammar, Daily English"
                            ...
                            <div>
                                ...
                                <input 
                                    ...
                                    placeholder="Contoh: bi-book-half"
                        ...
                        <div className="flex justify-end items-center gap-3 mt-4">
                            ...
                            >
                                <i className="bi bi-save mr-2"></i> {processing ? 'Menyimpan...' : 'Simpan Kategori'}
                            </button>
                        </div>
                    </form>
                </div>
