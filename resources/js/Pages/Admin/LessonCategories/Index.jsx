                                ...
                                <tbody className="divide-y divide-slate-100 dark:divide-slate-800">
                                    {categories.data && categories.data.length > 0 ? (
                                        categories.data.map((category) => (
                                            <tr key={category.id} className="hover:bg-[#fafcfb] dark:hover:bg-slate-850 transition-colors">
                                        ...
                                        <tr>
                                            <td colSpan="4" className="px-6 py-14 text-center">
                                                ...
                                                <h3 className="font-bold text-slate-900 dark:text-white text-base mb-1">Belum Ada Kategori Buku</h3>
                                                <p className="text-xs text-slate-400 dark:text-slate-500">Silakan tambahkan kategori buku baru untuk mulai menyusun materi pembelajaran.</p>
                                            </td>
                                        </tr>
                                    )}
                                </tbody>
