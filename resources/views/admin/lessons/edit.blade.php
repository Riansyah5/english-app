...
<div class="container py-4">
    ...
    <div class="d-flex align-items-center mb-5">
        ...
        <div>
            <h4 class="fw-bold mb-1 text-theme-main tracking-tight">Edit Materi 📝</h4>
            <p class="text-theme-muted mb-0 small">Perbarui isi bab materi pembelajaran teks digital.</p>
        </div>
    </div>
            ...
            <form action="{{ route('admin.lessons.update', $lesson->id) }}" method="POST">
                ...
                <div class="row g-4 mb-4">
                    ...
                    <div class="col-md-6">
                        ...
                        <input type="text" name="title" class="form-control form-control-minimal" value="{{ $lesson->title }}" required>
                    </div>
                    <div class="col-md-2">
                        <label class="form-label-minimal">Urutan <span class="text-danger">*</span></label>
                        <input type="number" name="order_number" class="form-control form-control-minimal" value="{{ $lesson->order_number }}" required>
                    </div>
                </div>
                ...
                <div class="minimal-box p-3 rounded-3 mb-4">
                    ...
                    <input type="text" name="youtube_url" class="form-control form-control-minimal" value="{{ $lesson->youtube_video_id ? 'https://www.youtube.com/watch?v=' . $lesson->youtube_video_id : '' }}" placeholder="Tempel URL YouTube di sini (Misal: https://www.youtube.com/watch?v=...)">
                ...
                <div class="form-check form-switch custom-switch mb-5">
                    ...
                    <label class="form-check-label text-theme-main fw-semibold small ms-2" for="publishSwitch">Terbitkan Materi Ini (Publish)</label>
                </div>

                <div class="d-grid">
                    <button type="submit" class="btn btn-minimal btn-minimal-primary py-2.5">
                        <i class="bi bi-cloud-arrow-up-fill me-1.5"></i> Perbarui Materi Pembelajaran
                    </button>
                </div>
            </form>
        </div>
...
<style>
/* ======================================================== */
/* MINIMALIST DESIGN SYSTEM - ADMIN LESSON EDITING          */
/* ======================================================== */
