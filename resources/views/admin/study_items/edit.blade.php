    ...
    <div class="row justify-content-center">
        <div class="col-md-10 col-lg-8">
            ...
            <div class="d-flex align-items-center mb-5">
                ...
                <div>
                    <h4 class="fw-bold mb-1 text-theme-main tracking-tight">Edit Materi ✏️</h4>
                    <p class="text-theme-muted mb-0 small">Perbarui informasi kosakata, frasa, atau aturan grammar.</p>
                </div>
            </div>
            ...
            <div class="minimal-card">
                <div class="card-body p-4 p-md-5">
                    <form action="{{ route('admin.study-items.update', $studyItem->id) }}" method="POST">
                        ...
                        <!-- English Content & Type Row Grid -->
                        <div class="row g-4 mb-4">
                            <div class="col-md-8">
                                <label for="content" class="form-label-minimal">Teks (Bahasa Inggris) <span class="text-danger">*</span></label>
                                <input type="text" class="form-control form-control-minimal @error('content') is-invalid-minimal @enderror" id="content" name="content" value="{{ old('content', $studyItem->content) }}" required autofocus>
                                @error('content')
                        ...
                        <div class="mb-4">
                            ...
                            <input type="text" class="form-control form-control-minimal @error('translation') is-invalid-minimal @enderror" id="translation" name="translation" value="{{ old('translation', $studyItem->translation) }}" required>
                            @error('translation')
                                <div class="invalid-feedback-minimal mt-1.5"><i class="bi bi-exclamation-circle me-1"></i>{{ $message }}</div>
                            @enderror
                        </div>
                        ...
                        <!-- Optional Context Example Input -->
                        <div class="mb-4">
                            ...
                            <textarea class="form-control form-control-minimal @error('example_sentence') is-invalid-minimal @enderror" id="example_sentence" name="example_sentence" rows="3">{{ old('example_sentence', $studyItem->example_sentence) }}</textarea>
                        ...
                        <div class="mb-4">
                            ...
                            <textarea class="form-control form-control-minimal @error('notes') is-invalid-minimal @enderror" id="notes" name="notes" rows="2">{{ old('notes', $studyItem->notes) }}</textarea>
                            @error('notes')
                                <div class="invalid-feedback-minimal mt-1.5"><i class="bi bi-exclamation-circle me-1"></i>{{ $message }}</div>
                            @enderror
                        </div>

                        <!-- Form Actions Control Row -->
                        <div class="d-flex justify-content-end align-items-center mt-5 gap-2">
                            ...
                            <button type="submit" class="btn btn-minimal btn-minimal-primary btn-sm px-4 py-2">
                                <i class="bi bi-cloud-arrow-up me-1.5"></i> Simpan Perubahan
                            </button>
                        </div>
...
<style>
/* ======================================================== */
/* MINIMALIST DESIGN SYSTEM - ADMIN BANK MATERI EDITING     */
/* ======================================================== */
