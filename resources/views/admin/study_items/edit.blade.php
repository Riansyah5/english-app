    ...
    <div class="row justify-content-center">
        <div class="col-md-10 col-lg-8">
            ...
            <div class="d-flex align-items-center mb-5">
                ...
                <div>
                    <h3 class="fw-bold mb-1 text-white text-glow" style="letter-spacing: -0.5px;">Edit Materi ✏️</h3>
                    <p class="text-slate mb-0 fw-medium">Perbarui informasi kosakata, frasa, atau tata bahasa.</p>
                </div>
            </div>
                    ...
                    <form action="{{ route('admin.study-items.update', $studyItem->id) }}" method="POST">
                        ...
                        <div class="row g-4">
                            <div class="col-md-8">
                                ...
                                <input type="text" class="form-control form-control-lg form-control-glass @error('content') is-invalid @enderror" id="content" name="content" value="{{ old('content', $studyItem->content) }}" required autofocus>
                                @error('content')
                        ...
                        <div class="mt-4">
                            ...
                            <input type="text" class="form-control form-control-lg form-control-glass @error('translation') is-invalid @enderror" id="translation" name="translation" value="{{ old('translation', $studyItem->translation) }}" required>
                            @error('translation')
                                <div class="invalid-feedback mt-2"><i class="bi bi-exclamation-circle me-1"></i>{{ $message }}</div>
                            @enderror
                        </div>
                        ...
                        <div class="mb-4">
                            ...
                            <textarea class="form-control form-control-glass @error('example_sentence') is-invalid @enderror" id="example_sentence" name="example_sentence" rows="3">{{ old('example_sentence', $studyItem->example_sentence) }}</textarea>
                        ...
                        <div class="mb-4">
                            ...
                            <textarea class="form-control form-control-glass @error('notes') is-invalid @enderror" id="notes" name="notes" rows="2">{{ old('notes', $studyItem->notes) }}</textarea>
                            @error('notes')
                                <div class="invalid-feedback mt-2"><i class="bi bi-exclamation-circle me-1"></i>{{ $message }}</div>
                            @enderror
                        </div>
