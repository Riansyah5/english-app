    ...
    <div class="row justify-content-center">
        <div class="col-md-8 col-lg-6">
            ...
            <div class="d-flex align-items-center mb-4">
                ...
                <div>
                    <h3 class="fw-bold mb-0">Edit Kategori Materi 📖</h3>
                </div>
            </div>
                ...
                <div class="card-body p-4 p-md-5">
                    <form action="{{ route('admin.lesson-categories.update', $lessonCategory->id) }}" method="POST">
                        ...
                        <div class="mb-3">
                            ...
                            <input type="text" name="name" class="form-control form-control-lg" placeholder="Misal: Grammar Dasar" required autofocus value="{{ $lessonCategory->name }}">
                        </div>

                        <div class="mb-3">
                            <label class="form-label fw-bold">Deskripsi Singkat</label>
                            <textarea name="description" class="form-control" rows="3" placeholder="Pelajaran tentang struktur kalimat bahasa Inggris..." value="{{ $lessonCategory->description }}"></textarea>
                        </div>

                        <div class="mb-4">
                            <label class="form-label fw-bold">Ikon Bootstrap</label>
                            <input type="text" name="icon" class="form-control" placeholder="Misal: bi-book" value="{{ $lessonCategory->icon }}">
                        </div>
