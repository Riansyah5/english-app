    ...
    <div class="row justify-content-center">
        <div class="col-md-8 col-lg-6">
            ...
            <div class="d-flex align-items-center mb-5">
                ...
                <div>
                    <h3 class="fw-bold mb-1 text-white text-glow" style="letter-spacing: -0.5px;">Edit Kategori Materi 📖</h3>
                    <p class="text-slate mb-0 fw-medium">Perbarui informasi pengelompokan bab pelajaran.</p>
                </div>
            </div>
                ...
                <div class="card-body p-4 p-md-5">
                    <form action="{{ route('admin.lesson-categories.update', $lessonCategory->id) }}" method="POST">
                        ...
                        <div class="mb-4">
                            ...
                            <input type="text" name="name" class="form-control form-control-lg form-control-glass rounded-4" placeholder="Misal: Grammar Dasar" required autofocus value="{{ $lessonCategory->name }}">
                        </div>
                        ...
                        <div class="mb-4">
                            ...
                            <textarea name="description" class="form-control form-control-glass rounded-4" rows="3" placeholder="Pelajaran tentang struktur kalimat bahasa Inggris...">{{ $lessonCategory->description }}</textarea>
                        </div>
                        ...
                        <div class="mb-5">
                            ...
                            <div class="input-group input-group-lg input-group-glass mb-2">
                                ...
                                <input type="text" name="icon" class="form-control form-control-glass border-start-0 ps-0" style="border-top-left-radius: 0; border-bottom-left-radius: 0;" placeholder="Misal: bi-book-half" value="{{ $lessonCategory->icon }}">
                        ...
                        <div class="d-grid mt-5 pt-2">
                            <button type="submit" class="btn btn-neon-primary btn-lg fw-bold rounded-pill shadow-sm d-flex align-items-center justify-content-center gap-2">
                                <i class="bi bi-cloud-arrow-up-fill fs-5"></i> Simpan Perubahan
                            </button>
                        </div>
