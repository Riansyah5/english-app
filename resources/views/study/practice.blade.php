    ...
    <div class="row justify-content-center">
        <div class="col-md-8 col-lg-7">
            ...
            <div class="d-flex justify-content-between align-items-center mb-4">
                <div>
                    <h4 class="fw-bold mb-1 text-white text-glow">Mode Latihan Bebas 🎮</h4>
                    <small class="text-slate fw-semibold letter-spacing-wide">Skor tidak akan disimpan</small>
                </div>
                ...
                <div class="d-flex gap-3 align-items-center">
                    <div id="directionToggle" class="glass-segmented-control position-relative d-flex rounded-pill user-select-none" style="cursor: pointer;">
                        ...
                        <div id="btnLangEnId" class="segment-btn flex-fill text-center position-relative z-1 fw-bold text-slate">EN ➔ ID</div>
                    </div>
            ...
            <div class="glass-card mb-3 p-3">
                <div class="d-flex flex-column flex-md-row align-items-md-center justify-content-between gap-3">
                    <span class="fw-bold text-slate small text-uppercase" style="letter-spacing: 1px;">Sumber Data:</span>
            ...
            <div class="glass-card mb-3 p-3 border-glow-info">
                <div class="d-flex flex-column flex-md-row align-items-md-center justify-content-between gap-3">
                    <span class="fw-bold text-slate small text-uppercase" style="letter-spacing: 1px;">Batas Jumlah:</span>
                    <div class="btn-group w-100 w-md-auto glass-btn-group" role="group">
            ...
            <div id="completionMessage" class="glass-card text-center d-none py-5 px-4 mb-4">
                <div class="mb-4 position-relative">
                    <div class="position-absolute top-50 start-50 translate-middle" style="width: 100px; height: 100px; background: radial-gradient(circle, rgba(56, 189, 248, 0.4) 0%, transparent 70%); filter: blur(15px); pointer-events: none;"></div>
                    <h1 class="display-1 mb-0 position-relative z-1 text-glow">🔁</h1>
                </div>
                <h3 class="fw-bold text-white mb-2 text-glow">Latihan Selesai</h3>
                <p class="text-slate mb-4" id="completionDesc">Anda telah mengulang semua materi di pengaturan ini.</p>
            ...
            <div id="flashcardContainer" class="fade-container mb-4">
                ...
                <div class="front-card glass-panel rounded-4 text-center active">
                    <div class="position-absolute top-0 end-0 opacity-25" style="width: 250px; height: 250px; background: radial-gradient(circle, rgba(16, 185, 129, 0.4) 0%, transparent 70%); transform: translate(20%, -20%); pointer-events: none;"></div>
                    ...
                    <div class="card-body p-4 p-md-5 d-flex flex-column justify-content-center h-100 position-relative z-1">
                        <div>
                            ...
                            <h1 class="display-4 fw-bold text-white mb-5 text-glow" id="itemContent">...</h1>
...
.border-glow-info {
    ...
    box-shadow: -5px 0 15px -5px rgba(56, 189, 248, 0.3), 0 16px 32px rgba(0, 0, 0, 0.3) !important;
}
...
.glass-btn-group .btn:not(:first-child) {
    margin-left: -1px;
}
...
document.addEventListener('DOMContentLoaded', function() {
    ...
    // EVENT: Toggle Switch Elegan
    directionToggle.addEventListener('click', function() {
        isReversed = !isReversed;
        this.classList.toggle('reversed');
        
        // Atur styling teks (aktif = putih, non-aktif = slate/abu)
        if (isReversed) {
            btnIdEn.classList.replace('text-white', 'text-slate');
            btnEnId.classList.replace('text-slate', 'text-white');
        } else {
            btnIdEn.classList.replace('text-slate', 'text-white');
            btnEnId.classList.replace('text-white', 'text-slate');
        }
        
        // Refresh konten kartu saat arah diganti
